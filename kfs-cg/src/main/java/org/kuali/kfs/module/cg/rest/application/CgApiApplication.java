 ...
 */
package org.kuali.kfs.module.cg.rest.application;
...
@ApplicationPath("/cg/api/v1")
public class CgApiApplication extends BaseApiApplication {

    public CgApiApplication() {
        super();
        if (SpringContext.getBean(ConfigurationService.class).getPropertyValueAsBoolean("apis.enabled")) {
            singletons.add(new BusinessObjectApiResource("cg"));
        }
    }
}
