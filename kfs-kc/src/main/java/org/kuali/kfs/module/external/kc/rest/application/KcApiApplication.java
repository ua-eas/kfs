 ...
 */
package org.kuali.kfs.module.external.kc.rest.application;
...
@ApplicationPath("/kc/api/v1")
public class KcApiApplication extends BaseApiApplication {

    public KcApiApplication() {
        super();
        if (SpringContext.getBean(ConfigurationService.class).getPropertyValueAsBoolean("apis.enabled")) {
            singletons.add(new BusinessObjectApiResource("kc"));
        }
    }
}