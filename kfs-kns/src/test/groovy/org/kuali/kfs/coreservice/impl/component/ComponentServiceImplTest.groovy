...
import org.kuali.kfs.coreservice.impl.namespace.NamespaceServiceImpl
...
class ComponentServiceImplTest {
    ...
    static final ComponentBo componentBo = convertComponent(component)
    ...
    void test_getActiveComponentsByNamespaceCode_exists() {
        boServiceMock.demand.findMatching { clazz, map ->
            if (!map.containsKey("active")) org.junit.Assert.fail("Did not pass active criteria")
            [componentBo]
        }
