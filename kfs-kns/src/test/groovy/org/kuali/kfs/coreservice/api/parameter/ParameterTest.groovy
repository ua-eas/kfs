...
public class ParameterTest {
    ...
    private create() {
		return org.kuali.kfs.coreservice.api.parameter.Parameter.Builder.create(new org.kuali.kfs.coreservice.api.parameter.ParameterContract() {
			...
			def org.kuali.kfs.coreservice.api.parameter.ParameterType getParameterType() { org.kuali.kfs.coreservice.api.parameter.ParameterType.Builder.create(new org.kuali.kfs.coreservice.api.parameter.ParameterTypeContract() {
