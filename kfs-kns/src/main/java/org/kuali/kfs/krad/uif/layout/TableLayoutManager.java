...
public class TableLayoutManager extends GridLayoutManager implements CollectionLayoutManager {
     ...
     * groups actions List
     * (CollectionGroup.getActionFields()). The
     ...
     * {@link CollectionGroup#getAddLineLabel()} and the add line actions will
     ...
     * will be set from
     * {@link CollectionGroup#getAddLineLabel()}. In addition,
     * {@link CollectionGroup#getAddLineActionFields()} will be added to the group
     * footer items.
     * </p>
     *
