...
public class LookupableImpl extends ViewHelperServiceImpl implements Lookupable {
    ...
    /**
     * @see ViewHelperServiceImpl#populateViewFromRequestParameters(View,
     * java.util.Map)
     */
    @Override
     ...
     * #initializeAttributeFieldFromDataDictionary(View, InputField)} method
     *
     * @see ViewHelperServiceImpl#performInitialization(View, java.lang.Object)
     */
    @Override
    ...
    /**
     * @see Lookupable#initSuppressAction(LookupForm)
     */
    @Override
...
//                }
    ...
    /**
     * @see Lookupable#validateSearchParameters
     */
    @Override
    ...
    /**
     * @see Lookupable#getReturnUrlForResults
     */
    ...
    /**
     * @see Lookupable#getMaintenanceActionLink
     */
     ...
     *
     * @see LookupableImpl#setMultiValueLookupSelect
     */
    @Override
    ...
    /**
     * @see Lookupable#setDataObjectClass
     */
    @Override
    ...
    /**
     * @see Lookupable#getDataObjectClass
     */
    @Override
    ...
    /**
     * @see Lookupable#setFieldConversions
     */
    @Override
    ...
    /**
     * @see Lookupable#setReadOnlyFieldsList
     */
    @Override
