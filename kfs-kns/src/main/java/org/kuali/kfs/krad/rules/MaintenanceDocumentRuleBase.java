...
public class MaintenanceDocumentRuleBase extends DocumentRuleBase implements MaintenanceDocumentRule {
    ...
    /**
     * @see MaintenanceDocumentRule#processSaveDocument(Document)
     */
    @Override
    ...
    /**
     * @see MaintenanceDocumentRule#processRouteDocument(Document)
     */
    @Override
    ...
    /**
     * @see MaintenanceDocumentRule#processApproveDocument(ApproveDocumentEvent)
     */
    @Override
    ...
    /**
     * @see MaintenanceDocumentRule#setupBaseConvenienceObjects(MaintenanceDocument)
     */
