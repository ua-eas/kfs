...
public final class ObjectUtils {
    ...
    public static String getFormattedPropertyValue(BusinessObject businessObject, String propertyName, Formatter formatter) {
        String propValue = org.kuali.kfs.krad.util.KRADConstants.EMPTY_STRING;
    ...
    public static String formatPropertyValue(Object propertyValue) {
        Object propValue = org.kuali.kfs.krad.util.KRADConstants.EMPTY_STRING;
        ...
        return propValue != null ? String.valueOf(propValue) : org.kuali.kfs.krad.util.KRADConstants.EMPTY_STRING;
    }
    ...
    */
    ...
    public static String clean(String string) {
        for (SearchOperator op : SearchOperator.QUERY_CHARACTERS) {
            string = StringUtils.replace(string, op.op(), org.kuali.kfs.krad.util.KRADConstants.EMPTY_STRING);
        }
        return string;
    }
