...
public interface CollectionLayoutManager extends LayoutManager {
     ...
     * @param lineFields          - the field instances for the collection line which were
     *                            copied from the collection groups items, id and binding
     *                            already updated
     * @param subCollectionFields - group field instances for each sub collection of the current
     *                            line
     * @param bindingPath         - binding path for the groups items (if DataBinding)
     * @param actions             - list of action instances for the collection line, with id
     *                            and binding updated
     * @param idSuffix            - suffix to use for any generated items
     * @param currentLine         - object instance for the current line, or null if add line
     * @param lineIndex           - index of the collection line being iterated over, or -1 if
     *                            the add line
     */
