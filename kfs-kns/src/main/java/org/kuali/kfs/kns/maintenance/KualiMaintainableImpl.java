...
import org.kuali.kfs.krad.maintenance.MaintainableImpl;
...
public class KualiMaintainableImpl extends MaintainableImpl implements Maintainable {
     ...
     * org.kuali.kfs.krad.maintenance.MaintenanceDocument, String)
     */
    ...
    public Map populateBusinessObject(Map<String, String> fieldValues, MaintenanceDocument maintenanceDocument,
        ...
        newFieldValues = getMaintenanceDocumentService().resolvePrincipalNamesToPrincipalIds(getBusinessObject(), fieldValues);
    ...
    public String getDocumentTitle(MaintenanceDocument document) {
        return super.getDocumentTitle((org.kuali.kfs.krad.maintenance.MaintenanceDocument) document);
    }
    ...
    /**
     * @param businessObject Sets the instance of a business object that will be
     *                       maintained.
     */
