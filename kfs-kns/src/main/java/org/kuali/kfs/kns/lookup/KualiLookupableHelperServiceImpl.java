...
public class KualiLookupableHelperServiceImpl extends AbstractLookupableHelperServiceImpl {
    ...
    public List<? extends BusinessObject> getSearchResults(Map<String, String> fieldValues) {
        return getSearchResultsHelper(
            org.kuali.kfs.krad.lookup.LookupUtils.forceUppercase(getBusinessObjectClass(), fieldValues), false);
    }
    ...
    public List<? extends BusinessObject> getSearchResultsUnbounded(Map<String, String> fieldValues) {
        return getSearchResultsHelper(
            org.kuali.kfs.krad.lookup.LookupUtils.forceUppercase(getBusinessObjectClass(), fieldValues), true);
    }
