...
public class SectionBridge {
    ...
    private static final Field getDeleteRowButtonField(String collectionName, String rowIndex) {
        ...
        deleteButtonField.setStyleClass("btn btn-red");
        deleteButtonField.setFieldLabel("Delete Row");
        deleteButtonField.setFieldShortLabel("Delete");
    ...
    private static final void addShowInactiveButtonField(Section section, String collectionName, boolean showInactive) {
        ...
        String imageText = showInactive ? "Show Inactive" : "Hide Inactive";

        String showInactiveButton = "property=" + methodName + ";value=" + imageText + ";alt=show(hide) inactive" + ";title=show(hide) inactive";
