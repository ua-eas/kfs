...
@Transactional
public class LookupResultsServiceImpl implements org.kuali.kfs.kns.lookup.LookupResultsService {
    ...
    public void persistSelectedObjectIds(String lookupResultsSequenceNumber, Set<String> selectedObjectIds, String personId) throws Exception {
        ...
        selectedObjectIdsBO.setSelectedObjectIds(
            org.kuali.kfs.kns.lookup.LookupUtils.convertSetOfObjectIdsToString(selectedObjectIds));
