...
import org.kuali.kfs.krad.inquiry.InquirableImpl;
...
public class KualiInquirableImpl extends InquirableImpl implements Inquirable {
    ...
    public HtmlData getInquiryUrl(BusinessObject businessObject, String attributeName, boolean forceInquiry) {
        try {
            if (PropertyUtils.isReadable(businessObject, attributeName)) {
                ...
                String fieldValue = objFieldValue == null ? KRADConstants.EMPTY_STRING : objFieldValue.toString();

                if (StringUtils.containsOnly(fieldValue, KRADConstants.DASH)) {
    ...
    protected AnchorHtmlData getHyperLink(Class inquiryClass, Map<String, String> fieldList, String inquiryUrl) {
        ...
        a.setObjectLabel(getDataDictionaryService().getDataDictionary().getBusinessObjectEntry(inquiryClass.getName()).getObjectLabel());
