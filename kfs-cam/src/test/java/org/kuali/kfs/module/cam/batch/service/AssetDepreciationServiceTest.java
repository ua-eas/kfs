...
public class AssetDepreciationServiceTest {
    ...
    private void recordMocks() throws Exception {
        ...
        fields.put(CamsPropertyConstants.AssetObject.UNIVERSITY_FISCAL_YEAR, 2009);
        ...
        EasyMock.expect(depreciableAssetsDao.generateStatistics(true, null, 2009, 1, depreciationCalendar, "",
                assetObjectCodes, 1, "Already ran")).andReturn(new ArrayList<String[]>());
        EasyMock.expect(depreciationBatchDao.getListOfDepreciableAssetPaymentInfo(2009, 1, depreciationCalendar))
        ...
        .andReturn(getObjectCode(2009, "BL", "5115")).anyTimes();
        ...
        EasyMock.expect(depreciableAssetsDao.generateStatistics(false, Arrays.asList(new String[]{"12345"}), 2009, 1, depreciationCalendar, "",
                assetObjectCodes, 1, "Already ran")).andReturn(new ArrayList<String[]>());
