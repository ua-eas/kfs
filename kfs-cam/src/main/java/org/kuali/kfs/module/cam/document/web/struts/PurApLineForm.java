...
public class PurApLineForm extends KualiForm {
    ...
    public void populate(HttpServletRequest request) {
        ...
        if (StringUtils.isNotBlank(parameterName)) {
            ...
            String purApDocIndex = StringUtils.substringBetween(parameterName, CamsConstants.DOT_DOC, ".");
            if (StringUtils.isNotBlank(purApDocIndex)) {
                this.setActionPurApDocIndex(Integer.parseInt(purApDocIndex));
            }
            String itemAssetIndex = StringUtils.substringBetween(parameterName, CamsConstants.DOT_LINE, ".");
