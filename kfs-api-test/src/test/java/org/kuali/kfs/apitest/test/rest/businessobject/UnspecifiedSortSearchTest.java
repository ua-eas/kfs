...
public class UnspecifiedSortSearchTest {
    ...
    private static String SUB_OBJECT_CODE_CURRENTS_SEARCH_API = "/api/v1/business-object/coa/sub-object-code-currents?limit=20";
    ...
    public void testBusinessObjectWithNoObjectIdButPrimaryKey() throws IOException {
        HttpResponse response = RestUtilities.makeRequest(SUB_OBJECT_CODE_CURRENTS_SEARCH_API, Constants.KHUNTLEY_TOKEN);
