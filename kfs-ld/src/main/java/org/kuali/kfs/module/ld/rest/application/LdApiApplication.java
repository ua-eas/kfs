 ...
 */
package org.kuali.kfs.module.ld.rest.application;
...
@ApplicationPath("/ld/api/v1")
public class LdApiApplication extends BaseApiApplication {

    public LdApiApplication() {
        super();
        if (SpringContext.getBean(ConfigurationService.class).getPropertyValueAsBoolean("apis.enabled")) {
            singletons.add(new BusinessObjectApiResource("ld"));
        }
    }
}
