            ...
            <div>
                ...
                <nav className="collapse navbar-collapse">
                    <ul className="nav navbar-nav pull-right">
                        <li>
                            <a href={prefs.remoteViewUrl + '?url=' + escape(actionListLink) + '?targetSpec=KFS:_parent,*:_blank'}><span className="glyphicon glyphicon-ok-sign"></span>Action List</a>
                        </li>
                        <li>
                            <a href={prefs.remoteViewUrl + '?url=' + escape(docSearchLink) + '&targetSpec=KFS:_parent,*:_blank'}><span className="glyphicon glyphicon-search"></span>Doc Search</a>
                        </li>
