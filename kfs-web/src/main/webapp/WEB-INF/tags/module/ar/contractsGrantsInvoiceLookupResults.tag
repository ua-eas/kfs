...
<c:if test="${!empty resultsList}">
    <div class="search-results">
        <kul:tableRenderPagingBanner
                pageNumber="${KualiForm.viewedPageNumber}"
                totalPages="${KualiForm.totalNumberOfPages}"
                firstDisplayedRow="${KualiForm.firstRowIndex}"
                lastDisplayedRow="${KualiForm.lastRowIndex}"
                resultsActualSize="${KualiForm.resultsActualSize}"
        ...
        <p>
            ...
            <html:submit
                    styleClass="btn btn-default"
                    property="methodToCall.prepareToReturnSelectedResults.x"
