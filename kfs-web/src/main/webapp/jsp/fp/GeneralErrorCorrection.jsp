...
<kul:documentPage showDocumentInfo="true"
	...
	<kul:tab tabTitle="Accounting Lines" defaultOpen="true" tabErrorKey="${KFSConstants.ACCOUNTING_LINE_ERRORS}" helpUrl="${KualiForm.getAccountingLineImportInstructionsUrl()}">
