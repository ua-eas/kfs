 ...
 */
package org.kuali.kfs.coa.rest.application;
...
@ApplicationPath("/coa/api/v1")
public class CoaApiApplication extends BaseApiApplication {

    public CoaApiApplication() {
        super();
        if (SpringContext.getBean(ConfigurationService.class).getPropertyValueAsBoolean("apis.enabled")) {
            singletons.add(new BusinessObjectApiResource("coa"));
        }
    }
}
