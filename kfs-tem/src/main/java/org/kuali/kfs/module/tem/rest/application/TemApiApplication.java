 ...
 */
package org.kuali.kfs.module.tem.rest.application;
...
@ApplicationPath("/tem/api/v1")
public class TemApiApplication extends BaseApiApplication {

    public TemApiApplication() {
        super();
        if (SpringContext.getBean(ConfigurationService.class).getPropertyValueAsBoolean("apis.enabled")) {
            singletons.add(new BusinessObjectApiResource("tem"));
        }
    }
}