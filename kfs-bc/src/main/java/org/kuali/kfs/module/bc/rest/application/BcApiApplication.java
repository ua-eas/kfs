 ...
 */
package org.kuali.kfs.module.bc.rest.application;
...
@ApplicationPath("/bc/api/v1")
public class BcApiApplication extends BaseApiApplication {

    public BcApiApplication() {
        super();
        if (SpringContext.getBean(ConfigurationService.class).getPropertyValueAsBoolean("apis.enabled")) {
            singletons.add(new BusinessObjectApiResource("bc"));
        }
    }
}
